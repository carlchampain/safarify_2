...
function AboutPage() {
  ...
  <h3 className="section-head">Where does all this cool data come from?</h3>
        ...
        <p className="ptags">
           The images of animals are provided by Flickr
        </p>
        <p className="ptags">
      ...
      <h3 className="section-head">Who built this website?</h3>
        ...
        <p className="ptags">
          Carl Champain: let's connect on <a rel="noopener noreferrer" target="_blank" href="https://www.linkedin.com/in/carl-champain-2901aa9a/">linkedin</a> or send me a message at <a href="mailto:safarifywebapp@gmail.com">safarifywebapp@gmail.com</a>!
        </p>
